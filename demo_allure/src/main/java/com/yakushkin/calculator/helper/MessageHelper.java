...
public class MessageHelper {
    ...
    public static final String LIST_OF_CLASSIFIER_TITLES_DOESNT_CONTAIN_EXPECTED_ELEMENT_MESSAGE =
            "The actual list of titles doesn't contain element(s) from expected list.";
}
